          ...
          <div className="steps2-container3">
            <div className="steps2-container4 thq-card">
              <h2 className="thq-heading-2">
                {props.step1Title ?? (
                  <Fragment>
                    <span className="steps2-text29">Join the Community</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Create an account and join the online community to start
                      engaging with fellow citizens.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      Share your thoughts, ideas, and concerns on community
                      issues through interactive forums and discussion boards.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container6 thq-card">
              <h2 className="thq-heading-2">
                {props.step3Title ?? (
                  <Fragment>
                    <span className="steps2-text30">Stay Informed</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Keep track of upcoming events, town hall meetings, and
                      public consultations by checking the event calendar and
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      ...
                      initiate projects, and make a positive impact on your
                      community.
                    </span>
                  </Fragment>
                )}
