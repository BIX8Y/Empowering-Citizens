              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3 className="pricing14-text108 thq-heading-3">
                    {props.plan1Price ?? (
                      <Fragment>
                        <span className="pricing14-text204">$0/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text199">$0/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <h3 className="pricing14-text115 thq-heading-3">
                    {props.plan2Price ?? (
                      <Fragment>
                        <span className="pricing14-text188">$9.99/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text168">$99.99/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text194">$199.99/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
