        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text16">/forums</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text24">/events</span>
                </Fragment>
              )}
            </a>
            <div
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text15">Join Now</span>
                  </Fragment>
                )}
              </span>
            </button>
                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text22">
                                  Welcome to Empowering Citizens - Your platform
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text20">Forums</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text23">
                                  Join discussions, share ideas, and collaborate
                                  with fellow citizens on community issues.
                                </span>
                              </Fragment>
                            )}
                          </span>
                      ...
                      <div className="navbar8-menu-item3">
                        ...
                        <div className="navbar8-content3">
                          <span className="navbar8-page31 thq-body-large">
                            {props.page3 ?? (
                              <Fragment>
                                <span className="navbar8-text25">Events</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text26">
                                  Stay updated on upcoming community events,
                      ...
                      <div className="navbar8-menu-item4">
                        ...
                        <div className="navbar8-content4">
                          <span className="navbar8-page41 thq-body-large">
                            {props.page4 ?? (
                              <Fragment>
                                <span className="navbar8-text19">About</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text14">
                                  Learn more about Empowering Citizens and our
                                  mission to foster civic participation.
                                </span>
                              </Fragment>
                            )}
                          </span>
                  ...
                  <div className="navbar8-content5">
                    ...
                    <span className="thq-body-small">
                      {props.page1Description ?? (
                        <Fragment>
                          <span className="navbar8-text22">
                            Welcome to Empowering Citizens - Your platform for
                  ...
                  <div className="navbar8-content6">
                    ...
                    <span className="thq-body-small">
                      {props.page2Description ?? (
                        <Fragment>
                          <span className="navbar8-text23">
                            Join discussions, share ideas, and collaborate with
                            fellow citizens on community issues.
                          </span>
                        </Fragment>
                      )}
                    </span>
                  ...
                  <div className="navbar8-content7">
                    ...
                    <span className="thq-body-small">
                      {props.page3Description ?? (
                        <Fragment>
                          <span className="navbar8-text26">
                            Stay updated on upcoming community events, town hall
                  ...
                  <div className="navbar8-content8">
                    ...
                    <span className="thq-body-small">
                      {props.page4Description ?? (
                        <Fragment>
                          <span className="navbar8-text14">
                            Learn more about Empowering Citizens and our mission
...
Navbar8.defaultProps = {
  ...
  page1ImageSrc:
    'https://images.unsplash.com/photo-1731348933899-eb4322cba09a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MTc0NTc0N3w&ixlib=rb-4.0.3&q=80&w=1080',
  action1: undefined,
  page2ImageAlt: 'Image for Forums Page',
  link2: undefined,
  linkUrlPage2: 'https://www.teleporthq.io',
  logoAlt: 'Empowering Citizens Logo',
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page3ImageAlt: 'Image for Events Page',
  linkUrlPage1: 'https://www.teleporthq.io',
  page1: undefined,
  link1: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1590091810319-741094e8db85?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MTc0NTc0N3w&ixlib=rb-4.0.3&q=80&w=1080',
  linkUrlPage3: 'https://www.teleporthq.io',
  page4: undefined,
  page2: undefined,
  link4: undefined,
  page4ImageAlt: 'Image for About Page',
  page1Description: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1558965509-228052befa6b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MTc0NTc0OHw&ixlib=rb-4.0.3&q=80&w=1080',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1612831454862-00d2c27dabbc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MTc0NTc0OHw&ixlib=rb-4.0.3&q=80&w=1080',
